    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex p-1 bg-slate-200 rounded-xl">
          <Button variant="primary" size="sm" className="rounded-lg">Gerar uma consulta</Button>
          <Button variant="ghost" size="sm" className="rounded-lg text-slate-600">Gerar um tratamento</Button>
        </div>
      </div>
        ...
        <Card title="Dados da Consulta">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Input label="Hora *" type="time" required icon={<Clock size={16} />} />
            </div>
          </div>
        </Card>
